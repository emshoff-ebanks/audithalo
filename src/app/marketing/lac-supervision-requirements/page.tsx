    ...
    <PainPage
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Your supervisor must hold an independent-level Arizona behavioral health license — LPC, LCSW, LMFT, licensed psychologist, or psychiatrist (R4-6-504(D)) — and complete 12 hours of initial supervisor training plus 6 continuing-education hours per renewal cycle. Substance-abuse counselors cannot provide clinical supervision hours toward LPC licensure, and no more than six supervisors total may contribute to a single application."
        },
        {
        ...
        },
        {
          ...
          a: "AuditHalo evaluates every logged session against each rule in R4-6-212, R4-6-503, and R4-6-504 as it happens — hours, ratios, cadence, observation, supervisor credential — and surfaces any gap before a board audit. Each session becomes a tamper-evident evidence package with date, duration, session type, credentials, topics, and intent-confirmed signatures, SHA-256 hashed and retained to satisfy the seven-year record obligation, so the board-defensible package is ready the day you apply."
        }
      ]}
