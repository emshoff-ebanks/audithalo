...
export default function CounselingSupervisionAuditChecklistPage() {
  return (
    <PainPage
      ...
      bodyParagraphs={[
        "State counseling boards (LCMHC, LPC, LCSW) don't publish their internal audit checklists, but the structure across the 10 states we cover — NC, CA, TX, FL, NY, AZ, DE, OH, LA, WA — converges on the same 12 items. Three of those items account for nearly every failed audit. Knowing which ones means the difference between a clean audit and a reapplication.",
