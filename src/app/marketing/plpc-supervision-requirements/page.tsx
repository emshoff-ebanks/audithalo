  ...
  return (
    <PainPage
      ...
      bodyParagraphs={[
        ...
        "The setting, not the supervision plan, is where Louisiana PLPCs make their most expensive mistake. Your practice setting must be board-approved before hours accrue there, and if you change or add a setting, you have 30 days to notify the Board. Miss that window and you forfeit ALL hours accrued at that setting (LAC 46:LX §603(A)(6)(d)). It is the harshest forfeiture rule in any state we track. AuditHalo timestamps every setting change and starts a 30-day countdown, so the obligation is visible long before it becomes a loss.",
        ...
        "AuditHalo encodes every one of these against the Board's exact citation. Each supervision session you log is evaluated against the rule in real time: the 1:20 ratio, the running individual-supervision share, the LPC-S credential snapshot at signing, the 2–6 year duration window, and the setting-approval status. The dashboard surfaces gaps months before a board audit would: a ratio drift, an unapproved setting, an individual share below 50 hours. Every session produces a board-defensible evidence package with intent-confirmed signatures.",
      ]}
      keyPoints={[
        {
        ...
        },
        {
          ...
          body: "Only the LPC-Supervisor designation from the Louisiana LPC Board qualifies. No other license type does. Each session's supervisor credential is snapshotted and validated at signing.",
        },
        {
