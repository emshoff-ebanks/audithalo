  ...
  return (
    <PainPage
      ...
      bodyParagraphs={[
        ...
        "The most expensive misread of the Ohio rule is the annual cap. No more than 1,500 hours of experience may be accrued in any 12-month period. That's a hard ceiling, not a guideline (OAC 4757-13-03(A)(4)(a)). Pack more than 1,500 hours into a single year and the overage simply doesn't count toward your 3,000. At least half of each year's hours must also be face-to-face client contact involving MED, so the 1,500-hour MED minimum is an obligation you carry every year, not just at the finish line.",
        "Ohio supervises by ratio, not by a fixed total: 1 hour of supervision for every 20 hours of work by the supervisee, which lands at roughly 150 supervision hours across the full 3,000 (OAC 4757-17-01(B)). There is no required split between individual and group supervision. Group sessions cap at 8 supervisees; Ohio's \"individual\" supervision is unusual in that it permits up to 2 supervisees, so a two-person session still counts as individual here. Your training supervisor must be an LPCC holding the Board's training-supervision designation. A clinical or work supervisor (a psychologist, psychiatrist, IMFT, or LISW) may oversee the MED work, but that doesn't satisfy the training-supervision requirement (OAC 4757-17-01(D)).",
        "Ohio does not require a pre-filed supervision contract. Instead, the supervisee maintains supervision records acknowledged by the supervisor at least quarterly, and the supervisor submits milestone evaluations at 1,500 and 3,000 hours. Each evaluation is due within 30 days of the supervisee's request, or the supervisor risks disciplinary action (OAC 4757-17-01(E)). The LPC must also disclose supervision status and name the supervisor on all printed and electronic client materials (OAC 4757-17-01(A)). AuditHalo encodes every one of these against the Board's exact citation and evaluates each logged session in real time, so the 1:20 ratio, the annual cap, and the two milestone deadlines surface as board-defensible gaps months before an audit would find them.",
      ]}
      keyPoints={[
        {
      ...
      faq={[
        ...
        },
        {
          ...
          a: "For training supervision toward the LPCC, the supervisor must be an LPCC holding the Board's training-supervision designation. Clinical or work supervisors (psychologists, psychiatrists, IMFTs, LISWs) may oversee MED activities, but they do not satisfy the training-supervision requirement (OAC 4757-17-01(D)).",
        },
        {
          q: "Does Ohio require a supervision contract before starting?",
          a: "No. Ohio does not require a pre-filed contract. The supervisee maintains supervision records acknowledged by the supervisor at least quarterly, and the supervisor submits milestone evaluations at 1,500 and 3,000 hours. Each is due within 30 days of the supervisee's request (OAC 4757-17-01(E)).",
        },
        {
