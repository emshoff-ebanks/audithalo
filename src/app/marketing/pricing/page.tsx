...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "NC + 1 other state rule", included: true },
      ...
      { label: "HR dashboard", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "All 5 supported states", included: true },
      { label: "HR dashboard + compliance heatmap", included: true },
      { label: "Executive risk rollup", included: true },
  ...
  },
  {
    ...
    description: "For multi-location practices and agencies.",
