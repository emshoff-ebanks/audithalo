  ...
  return (
    <PainPage
      ...
      bodyParagraphs={[
        ...
        "The second trap is timing. The supervisor must provide a signed declaration on the DOH form before supervision begins (WAC 246-809-234(3)). This is the pre-registration gate: hours that pre-date it are exposed in an audit. Your supervisor must also be a licensed LMHC or equally qualified practitioner (LMFT, LICSW, Psychologist, Psychiatrist, or Psychiatric NP), in good standing without restrictions for the prior two years. Cadence runs on a ratio: 1 hour of supervision per 80 hours of clinical practice (WAC 246-809-020(2)(b)). CACREP graduates receive credit for 500 practice hours and 50 supervision hours (WAC 246-809-230(4)).",
        "AuditHalo encodes every one of these against Washington's exact citation. Each supervision session you log is evaluated against the rule in real time. The dashboard surfaces gaps months before a Department of Health audit would catch them: a supervisor credential that lapsed, an immediate-supervision share running short, a cadence ratio slipping behind 1-in-80, or a missing declaration date. As of October 1, 2025, applicants may practice under supervision for up to 120 days while their LMHCA application is pending; AuditHalo tracks that window so nothing accrues outside it.",
      ]}
      keyPoints={[
        {
