...
export function EvidencePdf({ document: d, documentHash }: Props) {
  return (
    <Document
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.fineprint}>
            This hash is computed over the canonical JSON of this evidence package
            (keys sorted recursively). Any tampering — to the original record or to
            this PDF — produces a different hash, making the record independently
            verifiable. Generated by AuditHalo on{" "}
